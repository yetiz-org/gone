...
// Server represents a simple UDP server implementation
type Server struct {
	ch      channel.Channel
	Handler channel.Handler
}

// NewServer creates a new simple UDP server with the specified handler
...
// Start initializes and starts the UDP server on the specified address
...
// Channel returns the underlying server channel
...
// serverHandlerAdapter adapts user handlers to the UDP server framework
